...
public class UpdateServlet extends LanternServlet {
	...
	protected void doGet(HttpServletRequest _req, HttpServletResponse _rep) {
		if (isPath(_req, 0, "version"))
			...
			setResponseEntity(_rep, MediaType.APPLICATION_OCTET_STREAM, ResourceLoader.loadFile(LanternFiles.CONFIG_PATH + "release" + File.separator + "lantern-powermonitor.jar"));
	}
}
