...
<div class="row header-menu py-2">
    ...
    <div class="col"></div>
    <div class="col-auto mx-2"><a href="${link_prefix}export" class="text-decoration-none header-link fmnu1">DATA EXPORT</a></div>
    <div class="col-auto mx-2"><a href="${link_prefix}delete" class="text-decoration-none header-link fmnu1">DELETE ACCOUNT</a></div>
