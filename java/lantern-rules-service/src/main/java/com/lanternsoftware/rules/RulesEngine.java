...
public class RulesEngine {
	...
	private final PowerMonitorDao cmDao;
	...
	public RulesEngine() {
		...
		cmDao = new MongoPowerMonitorDao(MongoConfig.fromDisk(LanternFiles.CONFIG_PATH + "mongo.cfg"));
	...
	private void scheduleNextTimeEventForAccount(int _accountId) {
		...
		timeTasks.put(_accountId, nextTask);
